...
import { getAgoraRoomByChannel, startAgoraRoom, endAgoraRoom } from '@/lib/agoraHelpers';
...
export default function GroupVideoMeeting() {
  ...
  useEffect(() => {
    if (localVideoTrack && localVideoRef.current) {
      ...
      console.log('Local video container:', localVideoRef.current);
      console.log('Container dimensions:', {
        ...
        {gridView ? (
          ...
          <div className="h-full flex flex-col gap-2">
            ...
            <div className="flex-1 bg-gray-800 rounded-lg overflow-hidden relative">
              {remoteUsersList.length > 0 && remoteUsersList[0].videoTrack ? (
