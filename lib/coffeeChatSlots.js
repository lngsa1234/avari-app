...
const TIME_LABELS = { morning: 'Mornings (8-12)', afternoon: 'Afternoons (12-5)', evening: 'Evenings (5-8)', night: 'Nights (8-10)' }
const TIME_SHORT = { morning: 'Mornings', afternoon: 'Afternoons', evening: 'Evenings', night: 'Nights' }
