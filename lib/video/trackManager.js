      ...
      case 'webrtc': {
        ...
        if (element.tagName === 'DIV') {
          ...
          if (!mediaEl) {
            ...
            if (tag === 'video') {
              // WebRTC streams carry audio+video together — let audio play from the video element.
              // Agora/LiveKit handle audio via their own SDK, but this code path is WebRTC-only.
